...
var Events = (function () {
  ...
  _createClass(Events, [{
    ...
    value: function off(eventName, fn) {
      ...
      this._events['*'] = this._events['*'].filter(function (evt) {
        return evt.fn !== fn;
      });
      return this;
    }
...
var DateTimePicker = (function (_Events) {
  ...
  _createClass(DateTimePicker, [{
    ...
    value: function _hide() {
      ...
      this.pickerEl.classList.remove(prefix + '--open');
      this.scrimEl.classList.remove(this.options.styles.scrim + '--shown');
...
},{"./isInput":63}],54:[function(require,module,exports){
'use strict';
...
},{"./classes":55,"./clone":56,"./defaults":58,"./dom":59,"./momentum":64,"./noop":65,"./parse":66,"./text":78,"contra/emitter":47,"crossvent":51}],55:[function(require,module,exports){
'use strict';
...
},{"./momentum":64}],57:[function(require,module,exports){
'use strict';
...
},{"./index":60,"./inline":61,"./input":62,"./isInput":63}],58:[function(require,module,exports){
'use strict';
...
},{"./isInput":63,"./momentum":64,"./parse":66}],59:[function(require,module,exports){
'use strict';
...
},{"./calendar":54}],62:[function(require,module,exports){
'use strict';
...
},{"./calendar":54,"./classes":55,"./clone":56,"./defaults":58,"./momentum":64,"./throttle":79,"bullseye":34,"crossvent":51}],63:[function(require,module,exports){
'use strict';
...
},{"./momentum":64}],67:[function(require,module,exports){
'use strict';
...
},{"./core":57,"./index":60,"./polyfills/array.filter":67,"./polyfills/array.foreach":68,"./polyfills/array.indexof":69,"./polyfills/array.isarray":70,"./polyfills/array.map":71,"./polyfills/array.some":72,"./polyfills/function.bind":73,"./polyfills/object.keys":74,"./polyfills/string.trim":75,"./use":80,"./validators":81}],77:[function(require,module,exports){
'use strict';
...
},{"./rome":76,"moment":33}],78:[function(require,module,exports){
'use strict';
...
},{"./momentum":64}],81:[function(require,module,exports){
'use strict';
